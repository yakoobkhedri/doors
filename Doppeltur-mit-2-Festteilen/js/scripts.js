function changeSize(input) {
    ...
    GlasFront.style.top = 54.5 + size_terst + "mm";

    GlasFront2.style.height = size_height + "mm";
    GlasFront2.style.width = size_front2 + "mm";
    GlasFront2.style.top = 38.4 + size_front - size_terst + "mm";
    GlasFront2.style.right = 118 + size_front + "mm";
    ...
    let left = 63.5;
    if (document.getElementById("front").value < 400) left = 63.3;
