function changeSize() {
  ...
  let size_left2 = parseInt(document.getElementById("left2").value);
  ...
  GlasFront2.style.width = size_right2 + "mm";
  GlasFront2.style.height = size_height + "mm";

  GlasFront.style.width = size_left2 + "mm";
