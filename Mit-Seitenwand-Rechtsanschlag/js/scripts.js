function changeSize() {
  ...
  GlasRight.style.top = size_terstL + size_terstR - size_terst + 20 + "mm";
  GlasRight.style.left = size_front + size_left + 40 + "mm";

  GlasFront.style.height = size_height + "mm";
  GlasFront.style.width = size_front + "mm";
  GlasFront.style.top = size_terstL + 20 + "mm";
  GlasFront.style.left = size_left + 40 + "mm";

  GlasLeft.style.height = size_height + "mm";
  GlasLeft.style.width = size_left + "mm";
  GlasLeft.style.top = size_terstL + 20 + "mm";
